...
@interface CtyAVAssetExportSession ()
...
@implementation CtyAVAssetExportSession
{
    NSError *_error;
...
{
    return [CtyAVAssetExportSession.alloc initWithAsset:asset];
}
...
- (void)exportAsynchronouslyWithCompletionHandler:(void (^)())handler
{
    ...
    __weak CtyAVAssetExportSession *wself = self;
