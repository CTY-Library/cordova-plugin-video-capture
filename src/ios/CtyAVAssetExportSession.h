//
//  CtyAVAssetExportSession.h
//
// This file is part of the CtyAVAssetExportSession package.
//
...
@protocol CtyAVAssetExportSessionDelegate;


/**
 * An `CtyAVAssetExportSession` object transcodes the contents of an AVAsset source object to create an output
...
@interface CtyAVAssetExportSession : NSObject

@property (nonatomic, weak) id<CtyAVAssetExportSessionDelegate> delegate;
...
@protocol CtyAVAssetExportSessionDelegate <NSObject>

- (void)exportSession:(CtyAVAssetExportSession *)exportSession renderFrame:(CVPixelBufferRef)pixelBuffer withPresentationTime:(CMTime)presentationTime toBuffer:(CVPixelBufferRef)renderBuffer;
